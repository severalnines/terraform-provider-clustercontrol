# ---------------------------------------------------------------------------
# ClickHouse - standalone (single-node) example
#
...
# to true (not exposed as a variable), and db_clickhouse_native_port defaults
# to 9440 (ClickHouse's secure native TCP port) rather than the plaintext
# default of 9000.
# ---------------------------------------------------------------------------
