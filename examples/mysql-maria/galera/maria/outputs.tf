output "db_cluster_name" {
  ...
  value       = try(cc_db_cluster.this.db_cluster_name, null)
}

# output "db_cluster_status" {
#   description = "The DB cluster status"
#   value       = try(cc_db_cluster.this.status, null)
# }
...
#   value       = try(cc_db_cluster.this.primary, null)
# }
...
output "db_cluster_primary_port" {
  ...
  value       = try(cc_db_cluster.this.db_port, null)
}

output "db_admin_user" {
  description = "TODO"
  value       = try(cc_db_cluster.this.db_admin_username, null)
  sensitive   = true
}

output "db_admin_user_password" {
  description = "TODO"
  value       = try(cc_db_cluster.this.db_admin_user_password, null)
  sensitive   = true
}
