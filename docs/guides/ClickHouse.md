# Deploying ClickHouse Clusters
- [ClickHouse cluster deployment and configuration ](https://github.com/severalnines/terraform-provider-clustercontrol/tree/main/examples/clickhouse)
    - [ClickHouse cluster deployment and configuration example](https://github.com/severalnines/terraform-provider-clustercontrol/blob/main/examples/clickhouse/main.tf)
...
- [Scheduling backups](https://github.com/severalnines/terraform-provider-clustercontrol/tree/main/examples/clickhouse#scheduling-backups-using-the---clustercontrol_db_cluster_backup_schedule-resource)
- [Taking adhoc backups](https://github.com/severalnines/terraform-provider-clustercontrol/tree/main/examples/clickhouse#taking-adhoc-backups-using-the---clustercontrol_db_cluster_backup-resource)
