# Deploying Microsoft SQL Server Database Clusters
...
- [Scheduling backups](https://github.com/severalnines/terraform-provider-clustercontrol/tree/main/examples/mssql#scheduling-backups-using-the---clustercontrol_db_cluster_backup_schedule-resource)
- [Taking adhoc backups](https://github.com/severalnines/terraform-provider-clustercontrol/tree/main/examples/mssql#taking-adhoc-backups-using-the---clustercontrol_db_cluster_backup-resource)
