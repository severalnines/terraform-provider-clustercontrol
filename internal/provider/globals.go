...
var (
	gDefultDbPortMap = map[string]string{
		...
		CLUSTER_TYPE_CLICKHOUSE:     DEFAULT_CLICKHOUSE_NATIVE_PORT,
	}
)
...
var (
	gExtClusterTypeToIntClusterTypeMap = map[string]string{
		...
		EXT_CLUSTER_TYPE_CLICKHOUSE:         CLUSTER_TYPE_CLICKHOUSE,
	}
)
...
var (
	gIntClusterTypeToExtClusterTypeMap = map[string]string{
		...
		CLUSTER_TYPE_CLICKHOUSE:     EXT_CLUSTER_TYPE_CLICKHOUSE,
	}
)
...
var (
	gExtVendorIntVendorMap = map[string]string{
		...
		EXT_VENDOR_CLICKHOUSE: VENDOR_CLICKHOUSE,
	}
)
...
var (
	gIntVendorExtVendorMap = map[string]string{
		...
		VENDOR_CLICKHOUSE: EXT_VENDOR_CLICKHOUSE,
	}
)
...
var (
	gDefultDataDir = map[string]string{
		...
		CLUSTER_TYPE_CLICKHOUSE:     "/var/lib/clickhouse",
	}
)
...
var (
	...
	gDbAvailableBackupMethods = map[string]map[string][]string{
		...
		CLUSTER_TYPE_CLICKHOUSE: { // VENDOR_CLICKHOUSE
			VENDOR_CLICKHOUSE: {
				BACKUP_CLICKHOUSE_NATIVE_FULL,
				BACKUP_CLICKHOUSE_NATIVE_INCR,
			},
		},
		CLUSTER_TYPE_PG_SINGLE: { //
			VENDOR_DEFAULT: {
